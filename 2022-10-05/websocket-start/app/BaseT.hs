...
data EmailValidationError = MustNotBeEmpty
            | MustContainAt
            | MustContainPeriod
...
data PasswordValidationError =
  ...
  InvalidPassChars String String deriving (Generic,Show)